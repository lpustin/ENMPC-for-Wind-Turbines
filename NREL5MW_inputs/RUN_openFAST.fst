...
---------------------- INPUT FILES ---------------------------------------------
"ED_input.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"INFW_input.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"ServoDyn_OCP.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
      ...
      9999999   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
